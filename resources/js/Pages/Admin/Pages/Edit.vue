                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <VueMultiselect v-model="keywords" :options='[]' @tag='addKeyword' :multiple="true"
                                :taggable="true" :tag-placeholder="$t('enter_keywords')"
                        ...
                        <div class="text-end">
                            <button class="btn btn-success" @click='submit'>{{ $t('save_page') }}</button>
                        </div>
                    </div>
                </div>
...
const form = useForm({
    ...
    cover: props.page.cover,
    status: props.page.status == 1 ? true : false,
...
onMounted(() => {
    keywords.value = props.page.keywords.split(',')
})
